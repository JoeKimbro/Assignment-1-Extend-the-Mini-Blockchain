...
function main() {
    // 1) Create a chain
    const demoCoin = new Blockchain(5); // difficulty=3 is a good
    ...
    demoCoin.addBlock(new Block(3, Date.now().toString(), [
    { from: 'John', to: 'Joe', amount: 20 },
    { from: 'Gabe', to: 'Joe', amount: 10 },
    ]));
    console.log(' Mining block #5 ...');
    demoCoin.addBlock(new Block(3, Date.now().toString(), [
    { from: 'Joe', to: 'Gabe', amount: 30 },
    { from: 'John', to: 'Sarah', amount: 20 },
    ]));
    // 3) Show the chain
    console.log('\n Full chain:');
